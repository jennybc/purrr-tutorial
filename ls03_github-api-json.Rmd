...
<https://github.com/jennybc/purrr-tutorial/raw/gh-pages/github_users.json>. Use the code below to grab the JSON from GitHub (*this will soon be available within  [repurrrsive](https://github.com/jennybc/repurrrsive#readme)*).
